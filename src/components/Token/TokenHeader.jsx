...
const UserProfileCard = ({
  ...
  return (
    <div
      className="flex flex-col w-[390px] items-center pt-0 pb-3 px-0 relative"
      style={{
    ...
    >
      ...
      <div className="flex flex-col h-[148px] items-center justify-between px-3 w-full">
            ...
            <div className="inline-flex flex-col items-end gap-[3px]">
              <div className="flex items-center justify-end gap-1.5 w-full">
                <span className="h-[13px] px-[4.15px] py-[2.77px] bg-[#34c75933] rounded-[3px] flex items-center gap-[3px]">
                  <span className="text-[#34c759] text-[10px] tracking-[-0.30px] font-sans font-400">
                    {points}
                  </span>
              ...
              <div className="w-[76px] h-[13px] text-white text-xs text-right tracking-[-0.36px] font-sans font-400">
                {username}
              </div>
            </div>
        ...
        <div className="flex flex-col h-[57px] items-start gap-1 w-full">
          <h1 className="text-white text-[32px] leading-[35.8px] tracking-[-0.96px] truncate font-sans font-550">
            {title}
          </h1>
          <div className="inline-flex items-center gap-[3px]">
            <span className="text-[#ffffff91] text-[13.9px] tracking-[-0.28px] font-sans font-400">
              {title}
            </span>
